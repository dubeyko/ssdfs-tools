...
#define SSDFS_TESTFS_DEFAULT_MEM_PRIMITIVES_ITERATIONS	(100)
#define SSDFS_TESTFS_DEFAULT_MEM_PRIMITIVES_CAPACITY	(100)
#define SSDFS_TESTFS_DEFAULT_MEM_PRIMITIVES_COUNT	(100)
#define SSDFS_TESTFS_DEFAULT_MEM_PRIMITIVES_ITEM_SIZE	(4096)
